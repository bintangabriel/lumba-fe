            ...
            <div className="mt-8 pb-4 flex overflow-hidden relative">
              ...
              <div className="rounded-r-md shadow bg-white flex-1 min-h-[480px] overflow-auto">
                <div className="h-full flex flex-col w-full">
                  ...
                  <Step step={4}>
                    <StepContent position="right" className="-translate-x-52 translate-y-52">
                      <StepTitle>Clean Your Dataset</StepTitle>
                      <StepDescription>
                        Now you can view the table of your cleaned data. <br />
                  ...
                  <div className="w-full h-full p-4 relative">
                    <Image
                      src="/assets/LumbaCleanedDataTutorial.svg"
                      width={1180}
                      height={148}
...
export default CleaningTutorial4;
