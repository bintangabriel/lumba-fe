...
// export default function ObjectSegmentationTestModal({ CustomButton, features, type }) {
...
//             <span className="font-semibold">Image to be tested</span> <Question label="predictor variable" />
//           </div>
//           <div>
//             <UploadImage
//               buttonLabel={
